...
public class CCIndexer extends Configured implements Tool {

	private static Log LOG = LogFactory.getLog(CCIndexer.class);
	...
	public static void main(String[] args) {
		...
		try {
			exitCode = ToolRunner.run(new CCIndexer(), args);
		} catch (Exception e) {
	...
	public int run(String[] args) throws Exception {
		JobConf conf = new JobConf(CCIndexer.class);
		...
		conf.setMapperClass(CCIndexMapper.class);
		conf.setReducerClass(CCIndexReducer.class);
		
		// nothing much to combine
		//conf.setCombinerClass(CCIndexReducer.class);
